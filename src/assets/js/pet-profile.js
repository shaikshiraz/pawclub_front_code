...
$("#line_one").click( function() {
    if(countText_4 <5)
    {
        $(".one_line").append('<div class="col-md-12" id="remove_row3'+countText_4+'">\
        <div class="form-row">\
       ...
       $("#first_cat").click( function() {
        if(countText_5 <5)
        {
            $(".xyz_cat").append('<div class="col-md-12" id="remove_row4'+countText_5+'">\
            <div class="form-row">\
              <div class="col-md-2 col-lg-3">\
                <div class="">\
                <select id="breed_4" class="form-control" required>\
           ...
           $("#cat_first").click( function() {
            if(countText_6 <5)
            {
                $(".cat_kbc3").append('<div class="col-md-12" id="remove_row5'+countText_6+'">\
                <div class="form-row">\
                  <div class="col-md-2 col-lg-3">\
                    <div class="">\
                    <select id="breed_4" class="form-control" required>\
            ...
            return false
               ...
               $("#app_1").click( function() {
    
                {
                  if(countText_1<5)
                    $(".abc").append('<div class="row" id="remove_row'+countText_1+'">\
                        <div class="col-md-3" >\
                        <div class="form-group" >\<input   class="form-control" placeholder="Name of pets" />\
                        </div>\
                        </div>\
                        <div class="col-md-3" >\
                        <div class="form-group" >\
                        <input   class="form-control"  placeholder="Type of pets"/>\
                        </div>\
                        </div>\
                        <div class="col-md-3" >\
                        <div class="form-group" >\
                        <input   class="form-control"  placeholder="Name of owner" />\
                        </div>\
                        </div>\
                    <div class=" col-md-3 input-group mb-3">\
                    <input type="INR" class="form-control" placeholder="Phone Number">\
                    <div class="input-group-append">\
